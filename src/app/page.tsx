...
export default function LandingPage() {
      ...
      testimonials={[
        {
          name: "Marcus V.",
          handle: "@m.sports",
          testimonial: "BRGD changed how I approach my career. True professionals.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/fit-young-woman-sportswear-posing_23-2148759027.jpg",
        },
        {
          name: "Elena R.",
          handle: "@elena.athlete",
          testimonial: "The management here is unparalleled in Jacksonville.",
          rating: 5,
        ...
        },
        {
          name: "Carlos D.",
          handle: "@carlos.coach",
          testimonial: "Excellence and discipline in every detail.",
          rating: 5,
        ...
        },
        {
          name: "Sofia L.",
          handle: "@sofia.bjj",
          testimonial: "No shortcuts, just results. Best academy around.",
          rating: 5,
        ...
        },
        {
          name: "Pedro M.",
          handle: "@pedro.pro",
          testimonial: "The legacy they've built over 35 years is real.",
          rating: 5,
      ...
      avatars={[
        {
          ...
          alt: "Shaved head karate fighter sits on the tatami",
        },
        {
          src: "http://img.b2bpic.net/free-photo/front-view-hip-hop-performer-posing-one-hand_23-2148455956.jpg",
          alt: "Hip hop performer",
        },
        {
          src: "http://img.b2bpic.net/free-photo/athletic-tattooed-man-white-blank-tank-t-shirt-stretching-his-legs-touching-them-floor-left-side-position_346278-1584.jpg",
          alt: "Athletic man stretching",
        },
        {
          src: "http://img.b2bpic.net/free-photo/karate-fighters-tatami-fighting-championship_654080-1916.jpg",
          alt: "Karate fighters on tatami",
        },
        {
          src: "http://img.b2bpic.net/free-photo/young-brutal-bearded-muscular-man-wear-red-shirt-shorts-cap-stadium_627829-7589.jpg",
          alt: "Brutal bearded muscular man",
        },
      ]}
  ...
  <div id="about" data-section="about">
      ...
      description={[
        "BRGD Sports Group delivers strategic and innovative solutions across the key areas of high-performance sports. We combine 35 years of legacy with modern management techniques.",
        "Our integrated approach focuses on Athlete Management, Club Development, Sports Marketing, and large-scale event organization.",
      ]}
    />
  </div>
      ...
      features={[
        {
          ...
          description: "Identifying and developing talent with full career support.",
          imageSrc: "http://img.b2bpic.net/free-photo/two-men-having-conversation-dressing-room_329181-13228.jpg",
        },
        {
          title: "Club Management",
          description: "Performance-focused models for sustainable organizational growth.",
          imageSrc: "http://img.b2bpic.net/free-photo/athletic-man-texting-people-meet_482257-91400.jpg",
        },
        {
          title: "Sports Marketing",
          description: "Creative positioning to generate brand visibility and value.",
          imageSrc: "http://img.b2bpic.net/free-photo/training-supplies-near-tablet-with-picture_23-2147750794.jpg",
        },
        {
          title: "Event Organization",
          description: "Delivering high-standard sporting events and experiences.",
          imageSrc: "http://img.b2bpic.net/free-photo/male-field-hockey-coach-arena_23-2149668560.jpg",
        },
      ]}
      ...
      members={[
        {
          ...
          description: "Leading BRGD for over 24 years.",
          imageSrc: "http://img.b2bpic.net/free-photo/successful-confident-businessman-glasses-speaking-beige-wall_176420-129.jpg",
        },
        {
          id: "t2",
          name: "Lead Instructor",
          role: "Jiu Jitsu Legacy",
          description: "Shaping minds and bodies since day one.",
          imageSrc: "http://img.b2bpic.net/free-photo/side-view-men-practicing-tai-chi-together_23-2149960054.jpg",
        },
        {
          id: "t3",
          name: "Marketing Team",
          role: "Creative Lead",
          description: "Generating visibility for the BRGD brand.",
        ...
        },
        {
          ...
          description: "Optimizing efficiency across our centers.",
      ...
      faqs={[
        {
          id: "f1",
          title: "Who can join?",
          content: "We have classes for all ages, from toddlers to advanced adults.",
        },
        {
          id: "f2",
          title: "What is the mission?",
          content: "To empower athletes and brands through discipline, loyalty, and truth.",
        },
        {
          id: "f3",
          title: "Where are you located?",
          content: "We are based in Jacksonville, Florida.",
        },
      ]}
